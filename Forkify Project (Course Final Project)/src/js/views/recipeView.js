...
class RecipeView extends View{
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--increase-servings" data-goto="${+this._data.servings===1?1:+this._data.servings-1}">
                <svg>
    ...
    _generateIngredients(ing){
        return `<li class="recipe__ingredient">
              ...
              <div class="recipe__quantity">${ing.quantity!==null&&ing.quantity!==0?fractional(ing.quantity):''}</div>
